 ...
 * @author HP
 */
public class interfaceaulia extends javax.swing.JFrame {

    /**
     * Creates new form interfaceaulia
     */
    public interfaceaulia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\HP\\Pictures\\BMI-Charts.jpg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         else if(bmi >= 35)
        {
            ...
            jLabel7.setText("Extremely Obese");    
        }    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(interfaceaulia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new interfaceaulia().setVisible(true);
            }
        });
    }
